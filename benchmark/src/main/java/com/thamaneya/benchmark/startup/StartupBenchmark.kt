...
package com.thamaneya.benchmark.startup
...
import com.thamaneya.benchmark.BaselineProfileMetrics
...
class StartupBenchmark {
    ...
    companion object {
        const val PACKAGE_NAME = "com.thamaneya.androidchallenge"
    }
    @get:Rule
...
fun MacrobenchmarkScope.homeWaitForContent() {
    ...
    device.wait(Until.gone(By.res("ProgressView")), 5_000)
}
